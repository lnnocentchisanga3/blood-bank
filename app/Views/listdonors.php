                ...
                <tbody>
                   <?php if ($alldonors == null): ?>
                   	...
                   	<tr>
                        ...
                        <td><?=$row->site?></td>
                        <td>
                            <a href="<?=base_url()?>/listdonors/delete/<?=$row->serial_number?>" onclick="window.confirm('Are you sure you want to delete this record ?');" class="badge badge-danger py-2 col-sm-12 my-2"><i class="fa fa-trash"></i> Delete</a>
                            <a href="<?=base_url()?>/listdonors/edit/<?=$row->serial_number?>" class="badge badge-success py-2 col-sm-12 my-2"><i class="fa fa-edit"></i> Edit</a>
                        </td>
                    </tr>
                   		<?php endforeach ?>
                   <?php endif ?>
