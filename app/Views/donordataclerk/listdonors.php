...
<div class="row">
<div class="col-sm-12">
    <h4 class="page-title"><a href="<?=base_url()?>/donordataclerk/index/<?=$userdata['hospital_id']?>">Home</a> / Donors / List of all the donors</h4>
			...
			<div class="table-responsive">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-2"><a href="<?=base_url()?>/dataentry/<?=$userdata['hospital_id']?>" class="btn btn-primary my-3 btn-rounded"><i class="fa fa-plus"></i> Add Donors</a></div>
					</div>
				</div>
