                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12 ">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title d-inline-block">Upcoming Dates</h4> <a href="<?=base_url()?>/managedonationsites/<?=$userdata['hospital_id']?>" class="btn btn-primary float-right btn-rounded">View all Donation Sites <i class="fa fa-map-marker"></i></a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right noExport">
                                                    <a href="<?=base_url()?>/viewprintadata/<?=$row->site_id;?>/<?=$row->hospital_id?>" class="btn btn-outline-primary btn-rounded">View and Print <i class="fa fa-print"></i></a>
                                                </td>
                                            </tr>
                                                    <?php endforeach ?>
                                            <?php endif ?>
