...
<div class="row">
<div class="col-sm-12">
    <h4 class="page-title"><a href="<?=base_url()?>/donordataclerk/index/<?=$userdata['hospital_id']?>">Home</a> / Donors / Add a Donor</h4>
      ...
      <div class="table-responsive">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-2"><a href="<?=base_url()?>/listdata/<?=$userdata['hospital_id']?>" class="btn btn-primary my-3 btn-rounded"><i class="fa fa-folder-open"></i> View Donors</a></div>
          </div>
        </div>
       ...
       <form action="<?=base_url()?>/adddonors/dataentry/<?=$userdata['hospital_id']?>" method="POST">
