            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="<?= base_url()?>/donordataclerk/<?=$userdata['hospital_id']?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fa fa-user"></i> <span> Donors </span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a href="<?=base_url()?>/listdata/<?=$userdata['hospital_id']?>"><i class="fa fa-copy"></i> Manage Donors</a></li>
                                <li><a href="<?=base_url()?>/dataentry/<?=$userdata['hospital_id']?>"><i class="fa fa-users"></i> Add Multiple Donors</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li><a href="<?=base_url()?>/managedonationsites/<?=$userdata['hospital_id']?>"><i class="fa fa-map-marker"></i>Manage Donation Sites</a></li>

                                <?php if ($sites == null): ?>
                                    <li><a href="#!"><i class="fa fa-map"></i> -No Donation Sites Found</a></li>
                                <?php else: ?>
                                    <?php foreach ($sites as $row): ?>
                                       <li><a href="<?=base_url()?>/viewdonationsitedata/<?=$row['site_id']?>/<?=$row['hospital_id']?>"><h6 style="border-left: 1px solid black; padding-top: initial;" class="text-end">--<i class="fa fa-folder-open"></i> <?=$row['donation_site_name']?></h6></a></li>
                                    <?php endforeach ?>
                               <?php endif ?>
                            </ul>
                        </li>
