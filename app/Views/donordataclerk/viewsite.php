...
<?php if ($sitedata == null || $sitedata == ''): ?>
    <h2 class="col-md-12 text-center my-5">There are no Donors from this Donation Site <i class="fa fa-map-marker"></i> <br><br><a href="<?=base_url()?>/managedonationsites/<?=$userdata['hospital_id']?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Go back to donation sites</a></h2>
<?php else: ?>
    <div class="row">
<div class="col-sm-12">
      ...
      <div class="table-responsive">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-4"><a href="<?=base_url()?>/managedonationsites/<?=$userdata['hospital_id']?>" class="btn btn-primary btn-rounded"><i class="fa fa-arrow-left"></i> Go back to donation sites</a></div>
          </div>
        </div>
