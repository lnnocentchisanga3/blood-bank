            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="">
                            <a href="<?= base_url()?>/donorsection/<?=$userdata['hospital_id']?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fa fa-user"></i> <span> Donors </span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a href="<?=base_url()?>/donorsectionAlldonors/<?=$userdata['hospital_id']?>"><i class="fa fa-copy"></i> List All Donors</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <!-- <li><a href="<?=base_url()?>/donorsectiondonationsites/<?=$userdata['hospital_id']?>"><i class="fa fa-map-marker"></i> Donation Sites</a></li> -->
